...
console.log("🚀 Welcome to Destiin Setup!");
console.log(
...
async function createEnvFile() {
  ...
  const mongodbUri =
    (await prompt(
      "🔗 MongoDB URI (default: mongodb://localhost:27017/Destiine_travel_agency): ",
    )) || "mongodb://localhost:27017/Destiine_travel_agency";
  const baseUrl =
