...
export const baggageAllowanceSchema = new Schema(
  {
    ...
    carryOn: {
      ...
      required: false, // Optional since subdocument has its own required fields
    },
    checked: {
      type: baggagePieceAllowanceSchema,
      required: false, // Optional since subdocument has its own required fields
...
const airlinePolicySchema = new Schema({
  ...
  flightType: {
    ...
    default: "International", // Default to International
        required: true, // ⬅️ this is enforcing the error
